...
type AboutProps = {
  stats: { length: number } | null;
};

function About({ stats }: AboutProps) {
  return (
    <section>
      <p className='text-kanagawa-fg max-w-96'>
        Hi, I&apos;m Red. I&apos;m currently a <b className='text-kanagawa-red'>Software Engineer II</b> at{' '}
        <b className='text-kanagawa-red'>Commerce Architects</b>.
      </p>
      <div className='text-kanagawa-fg flex flex-col items-center gap-12 py-6 italic lg:flex-row lg:py-12'>
        ...
        <div className='space-y-2 text-sm lg:text-base'>
          <a
            ...
            target='_blank'
            className='hover:text-kanagawa-red flex items-center gap-2 transition-colors'
          >
            <FaAws />
      ...
      <div className='text-kanagawa-fg flex flex-col gap-6'>
        <p>
      ...
      <div className='text-kanagawa-fg flex flex-col gap-2 text-sm lg:flex-row lg:gap-6'>
        <span className='hover:text-kanagawa-red flex items-center gap-2 transition-colors'>
          <FaArrowTrendUp />
