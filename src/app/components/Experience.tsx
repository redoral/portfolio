    ...
    <section className='py-6' id='experience'>
      ...
      <ol className='relative border-l border-gray-200 dark:border-neutral-600 mt-2'>
        <li className='mb-5 ml-4'>
          ...
          <time className='mb-1 text-sm font-normal leading-none'>January 2023 - Present</time>
          ...
          <p className='mb-4 text-sm lg:text-base font-normal text-gray-600 dark:text-neutral-300'>
        ...
        <li className='ml-4'>
          ...
          <p className='text-sm lg:text-base font-normal text-gray-600 dark:text-neutral-300'>
